...
the teacher, builds a $k$-nearest-neighbor graph whose per-row bandwidth is
read off the retrieved similarities, and supervises each anchor on its own
retrieved neighborhood, every column included. The deduplicated candidate pool of a batch is encoded
