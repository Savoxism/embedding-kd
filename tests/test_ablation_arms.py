"""The baseline arms: each must be exactly one thing away from the method.
...
the half that fails silently: a deletion arm that also changes the row set
produces a clean-looking number that means something else.
"""
