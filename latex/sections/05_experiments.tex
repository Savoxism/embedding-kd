...
Table~\ref{tab:main_results} provides the planned reporting format. The key comparison is whether HeatGeo improves downstream embedding quality relative to local distillation baselines while retaining the efficiency of the compact student. We expect gains to be most visible on tasks that depend strongly on neighborhood geometry, such as semantic textual similarity and pair classification.
